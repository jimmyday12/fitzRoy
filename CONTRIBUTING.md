# Contributing to fitzRoy

This outlines how to propose a change to fitzRoy. In general, this
package follows principles from the tidyverse development world. You can
see the detailed guidelines for contributing in the the [**development
contributing guide**](https://rstd.io/tidy-contrib).

The rest of this guide is taken directly from tidyverse with some slight
ammendments.
...
Code of
Conduct](https://jimmyday12.github.io/fitzRoy/CODE_OF_CONDUCT.md). By
