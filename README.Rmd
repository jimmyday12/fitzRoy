...
The primary functions in `fitzRoy` are the `fetch_*` functions. These provide access to the most common types of data using a consistent API.  

The four main functions are `fetch_fixture`, `fetch_results`, `fetch_ladder` and `fetch_player_stats`. 
...
See vignette on using the [main fetch functions](https://jimmyday12.github.io/fitzRoy/articles/main-fetch-functions.html) to learn more. 
