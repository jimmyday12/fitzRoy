...
sticker(
  ...
  subplot = "inst/figures/footy_flipped.png",          # sticker feature
  s_x = 1,                               # x of feature
  ...
  filename = "inst/figures/fitz_hex.png"                 # location to save the image
)
knitr::include_graphics("inst/figures/fitz_hex.png", dpi = 600)
```
