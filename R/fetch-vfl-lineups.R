#' Fetch upcoming VFL team lineups
#'
#' @return A tibble of upcoming VFL team lineups with guernsey numbers
#' @export
#'
#' @examples
#' fetch_vfl_lineups()
fetch_vfl_lineups <- function() {
  url <- "https://vfl.aflmstats.com/lineups"
  
  page <- tryCatch({
    rvest::read_html(url)
  }, error = function(e) {
    stop("Failed to retrieve VFL lineups. Check the URL or your internet connection.")
  })
