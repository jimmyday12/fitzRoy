#' Fetch VFLW Coleman Medal leaderboard for a given season
#'
...
#'
#' @examples
#' fetch_vflw_coleman(2025)
fetch_vflw_coleman <- function(season = 2025) {
  if (!season %in% 2021:2025) stop("Season must be between 2021 and 2025")
  
  url <- paste0("https://vfl.aflwstats.com/coleman/", season)
