#' Fetch VFLW squad experience by team for a given season
#'
...
#'
#' @examples
#' fetch_vflw_experience(2025)
fetch_vflw_experience <- function(season = 2025) {
  if (!season %in% 2021:2025) stop("Season must be between 2021 and 2025")
  
  url <- paste0("https://vfl.aflwstats.com/xp/", season)
