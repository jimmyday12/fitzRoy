#' Fetch VFLW ladder for a given season
#'
#' Scrapes the ladder from https://vfl.aflwstats.com for the selected season.
#'
...
#'
#' @examples
#' fetch_vflw_ladder(2025)
fetch_vflw_ladder <- function(season = 2025) {
